...
async def main():
    ...
    parser.add_argument('--coordinator', default='http://sn-1.vltgg.net:21800', help='Coordinator URL')
    parser.add_argument('--proxy', default='http://sn-1.vltgg.net:21801', help='Proxy URL')
